...
import { Check, ChevronRight, X, ArrowRight, Gauge, Zap, Weight, ArrowUpFromLine, Fuel, Settings, Trophy } from 'lucide-react';
        ...
        <div className="w-full md:w-1/2 flex flex-col h-full bg-white relative">
          ...
          <div className="flex-1 overflow-y-auto p-6 md:p-8">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              ...
              <span className="px-3 py-1 bg-amber-50 text-amber-700 rounded-full text-sm font-medium border border-amber-100 uppercase">
                {bike.category}
              </span>
            </div>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Technical Specifications</h3>
                <div className="grid grid-cols-2 gap-x-4 gap-y-3 bg-gray-50 p-4 rounded-xl">
                  <div className="flex flex-col">
                    <span className="text-gray-400 text-xs uppercase">Engine</span>
                    <span className="font-semibold text-gray-900">{bike.engineCapacity}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-gray-400 text-xs uppercase">Power</span>
                    <span className="font-semibold text-gray-900">{bike.power}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-gray-400 text-xs uppercase">Weight</span>
                    <span className="font-semibold text-gray-900">{bike.weight}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-gray-400 text-xs uppercase">Seat Height</span>
                    <span className="font-semibold text-gray-900">{bike.seatHeight}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-gray-400 text-xs uppercase">Fuel Tank</span>
                    <span className="font-semibold text-gray-900">{bike.fuelCapacity || 'N/A'}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-gray-400 text-xs uppercase">Top Speed</span>
                    <span className="font-semibold text-gray-900">{bike.topSpeed || 'N/A'}</span>
                  </div>
                </div>
              </div>
              ...
              {bike.features && bike.features.length > 0 && (
                <div>
                  <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Key Features</h3>
          ...
          {/* Sticky Footer */}
          <div className="p-6 border-t border-gray-100 bg-white flex items-center justify-between mt-auto shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-10">
            <div>
            ...
            <Link 
              to="/contact" 
              className="bg-gray-900 text-white px-8 py-3 rounded-xl font-bold hover:bg-gray-800 transition flex items-center gap-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="space-y-8">
            {filteredBikes.map((bike, index) => (
              ...
              >
                {/* Image Side */}
                <div className="w-full lg:w-3/5 relative h-64 lg:h-96 group overflow-hidden">
                  <img 
                    src={bike.image} 
                    alt={bike.name} 
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
